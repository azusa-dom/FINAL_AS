...
\renewcommand{\includegraphics}[2][]{%
  \IfFileExists{#2}{\Oldincludegraphics[#1]{#2}}{\fbox{\texttt{\detokenize{#2}}}}}%
\makeatother
...
% Hyperref: force driver per engine to avoid driver mismatch under Tectonic/XeTeX
\ifPDFTeX
...
\graphicspath{{figures/}{results/figures/}{../../results/figures/}{results/figures_generated/}{../../results/figures_generated/}{vertopal_9877a777d34043fea0110a83eb29bb37/media/}}
...
% Footnotes and quotations single spacing
\let\oldfootnote\footnote
\renewcommand{\footnote}[1]{\oldfootnote{\singlespacing #1}}

% Single spacing for quotation environment
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{fig_dataset_counts.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth, height=0.5\textheight, keepaspectratio]{fig_model_auroc.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth, height=0.5\textheight, keepaspectratio]{fig_model_ece.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth, height=0.4\textheight, keepaspectratio]{fig_mri_l2o_hist.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth, height=0.4\textheight, keepaspectratio]{fig_mri_l2o_line.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth, height=0.5\textheight, keepaspectratio]{fig_feature_importance_gb.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth, height=0.4\textheight, keepaspectratio]{fig_feature_importance_rf.png}
