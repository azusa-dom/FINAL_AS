...
## 📚 Motivation and Novelty
  ...
  - [cite\_start]The early diagnosis of AS remains clinically challenging. [cite: 241, 242] [cite\_start]While laboratory and MRI data both offer diagnostic insights, real-world clinical practice often lacks paired multimodal datasets. [cite: 253, 280]
...
|---|---|---|---|
| Clinical | 4,254 | [cite\_start]27 structured variables (labs, HLA-B27) [cite: 303, 328] | FFNN model training & evaluation |
...
### 🔬 1. Clinical Pipeline
  ...
  - [cite\_start]**Features**: 27 structured variables, including CRP, ESR, BASDAI, and HLA-B27. [cite: 328]
  - **Preprocessing**:
      - [cite\_start]Median imputation for continuous features. [cite: 330]
      - [cite\_start]Mode imputation and one-hot encoding for categorical variables. [cite: 330, 332]
  ...
  - **Training**:
      ...
      - [cite\_start]5-fold stratified cross-validation. [cite: 199]
...
### 🧠 2. MRI Feasibility Pipeline
  ...
  - **Aggregation**:
      - [cite\_start]Slice-level features are aggregated per subject via mean pooling. [cite: 43, 56, 147]
  - **Evaluation**:
      - [cite\_start]**Classifier**: Logistic Regression. [cite: 14, 44, 53, 72]
      - [cite\_start]**Cross-validation**: Leave-One-Out CV (LOOCV). [cite: 44, 47, 52, 68]
      - **Metric**: AUC with a 95% CI via 2000x bootstrap.
      - [cite\_start]**Permutation Test**: N=5000 to assess statistical separation of features. [cite: 48, 57, 75, 138]
  - **Visualization**:
...
| Brier Score | [cite\_start]0.138 [cite: 503, 512] | Post-calibration |
| ECE₁₀ | [cite\_start]0.021 [cite: 503, 512] | Expected Calibration Error |
| DCA Net Benefit | [cite\_start]+0.18 (at p=0.3) [cite: 236, 393] | Decision Curve Analysis |
